...
The code below loads and cleans the Airbnb data, which we’ll use as a
primary example for fitting linear models.
...
A good place to start is to consider price as an outcome that may depend
on rating and borough. We fit that initial model in the following code.
...
| stars             |   31.990 |   0.000 |
| Bourough:Brooklyn |  -49.754 |   0.000 |
| Bourough:Queens   |  -77.048 |   0.000 |
| Bourough:Bronx    |  -90.254 |   0.000 |
